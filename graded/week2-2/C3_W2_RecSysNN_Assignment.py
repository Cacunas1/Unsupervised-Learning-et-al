...
# + deletable=false editable=false id="Xu-w_RmNwCV5"
import numpy as np
...
# + deletable=false editable=false id="M5gfMLYgxCD1"
...
# + deletable=false id="CBjZ2HhRwpa0"
# GRADED_CELL
# UNQ_C1
...
# + deletable=false editable=false id="pGK5MEUowxN4"
tf.random.set_seed(1)
cost_fn = tf.keras.losses.MeanSquaredError()
opt = keras.optimizers.Adam(learning_rate=0.01)
model.compile(optimizer=opt, loss=cost_fn)

# + deletable=false editable=false id="6zHf7eASw0tN"
tf.random.set_seed(1)
...
# + deletable=false id="4_7nZyPiVJ4r"
new_user_id = 5000
new_rating_ave = 0.0
new_action = 0.0
new_adventure = 5.0
